class UserModel {
  ...
  UserModel({required this.uid, required this.nama, required this.email, required this.role,
    this.fotoUrl, this.noTelepon, this.sosialMedia, this.cvUrl, this.portofolioUrl, this.usia,
  ...
  factory UserModel.fromMap(Map<String, dynamic> m, String uid) => UserModel(
    ...
    fotoUrl: m["fotoUrl"], noTelepon: m["noTelepon"], sosialMedia: m["sosialMedia"],
    cvUrl: m["cvUrl"], portofolioUrl: m["portofolioUrl"], usia: m["usia"],
  ...
  Map<String, dynamic> toMap() => {
    ...
    "noTelepon": noTelepon, "sosialMedia": sosialMedia,
    "cvUrl": cvUrl, "portofolioUrl": portofolioUrl, "usia": usia,
