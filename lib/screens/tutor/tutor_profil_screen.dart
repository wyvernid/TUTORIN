...
import 'tutor_upload_cv_screen.dart';
...
class _State extends State<TutorProfilScreen> {
  ...
  Future<void> _updateFoto(ImageSource src) async {
    ...
    try {
      final f = src == ImageSource.camera
          ? await _storage.ambilDariKamera()
          : await _storage.ambilDariGaleri();
      if (f == null) return;
      final uid = FirebaseAuth.instance.currentUser!.uid;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              icon: const Icon(Icons.edit_rounded), onPressed: _showEdit)
        ],
      ),
      body: u == null
          ...
          : SingleChildScrollView(
              ...
              Padding(
                  ...
                  child: Row(children: [
                    _stat('${u.totalMurid}', 'Murid', Icons.people_rounded,
                        const Color(0xFF1565C0)),
                    const SizedBox(width: 10),
                    _stat(u.rating > 0 ? u.rating.toStringAsFixed(1) : '-',
                            ...
                            if (u.punyaRekening) ...[
                              ...
                              Container(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(
                                      child: Text(
                                    'Belum ada rekening. Student tidak bisa melihat tujuan transfer saat booking kelasmu.',
                                    style: TextStyle(
                                        fontSize: 11,
  ...
  /// Row rekening seperti di student_booking_screen
  Widget _rekeningRow(String bank, String number, String name) => Row(children: [
        Container(
            width: 50,
            height: 28,
            decoration: BoxDecoration(
      ...
      builder: (_) => SafeArea(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              _fotoOpt(Icons.camera_alt_rounded, 'Kamera', () {
                Navigator.pop(context);
                _updateFoto(ImageSource.camera);
              }),
              _fotoOpt(Icons.photo_library_rounded, 'Galeri', () {
                Navigator.pop(context);
                _updateFoto(ImageSource.gallery);
              }),
            ]),
            const SizedBox(height: 14),
          ])));

  Widget _fotoOpt(IconData icon, String label, VoidCallback onTap) =>
      GestureDetector(
          onTap: onTap,
          child: Column(children: [
            Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(
                          onPressed: () async {
                            await _auth.updateProfil(
                                FirebaseAuth.instance.currentUser!.uid, {
                              'nama': n.text.trim(),
                              'noTelepon': t.text.trim(),
                            });
                            await _load();
  ...
  void _showEditRekening() {
    ...
    final nomor  = TextEditingController(text: _user?.nomorRekening ?? '');
    final nama   = TextEditingController(text: _user?.namaRekening ?? '');
            ...
            child: Container(
                ...
                decoration: const BoxDecoration(
                    ...
                    borderRadius:
                        BorderRadius.vertical(top: Radius.circular(24))),
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  const Text('Info Rekening',
                      style: TextStyle(
                          fontSize: 16, fontWeight: FontWeight.w800)),
                  const SizedBox(height: 4),
                  Text(
                    'Rekening ini yang ditampilkan ke student saat booking kelasmu.',
                  ...
                  TextField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          hintText: '08xxxxxxxxxx atau 1234567890',
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(
                          onPressed: () async {
                            await _auth.updateProfil(
                                FirebaseAuth.instance.currentUser!.uid, {
                              'namaBank':      bank.text.trim(),
                              'nomorRekening': nomor.text.trim(),
                              'namaRekening':  nama.text.trim(),
                            });
                            await _load();
                            if (mounted) Navigator.pop(context);
                          },
