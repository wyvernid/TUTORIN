...
class _TutorHomeScreenState extends State<TutorHomeScreen> {
  ...
  final List<Widget> _screens = [
    const TutorBerandaScreen(),
    const TutorKelasScreen(),
    const TutorChatListScreen(),
    const TutorProfilScreen(),
  ];
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                _NavItem(index: 0, icon: Icons.dashboard_rounded, label: 'Beranda', current: _currentIndex,
                    onTap: () => setState(() => _currentIndex = 0)),
                _NavItem(index: 1, icon: Icons.class_rounded, label: 'Kelas', current: _currentIndex,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, color: isActive ? const Color(0xFF1565C0) : const Color(0xFFB0BEC5), size: 24),
